...
namespace BattleCity
{
    ...
    {
        //Properties
        private FormGameplay frmGame;            //Nơi màn hình chờ hiển thị
        ...
        private void InitControls()
        {
            ...
            introduction = new Label
            {
                ...
                Text = "Drama nổ ra và các chị em bắt đầu vác súng để săn lùng tin tặc ....",
                AutoSize = true,
        ...
        private void animationRocket(object sender, EventArgs e)
        {
            ...
            if (rocket.Top < 250)
            {
                ...
                introduction.Text = "Bạn là người mang sứ mệnh truy lùng những kẻ đó...";
                timerrocket.Stop();
                timerball.Start();
            }
        }
