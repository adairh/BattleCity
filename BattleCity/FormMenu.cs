...
namespace BattleCity
{
    public partial class FormMenu : Form
    {
        ...
        private void GetImage()
        {
            ...
            buttonList[1].Image = Properties.Resources.btnHighScore;
            buttonList[2].Image = Properties.Resources.btnAbout;
        ...
        //
        ////Hàm xử lý xự kiện khi nhấn button thì button sẽ đổi màu background
        ...
        //Hàm update điểm của người chơi
        public void UpdateScore(int score, double clock)
        {
           data.UpdateScore(score,clock);
        }
